...
packet_arrival_event(Simulation_Run_Ptr simulation_run, void * ptr)
{
  ...
  new_packet->service_time = get_packet_transmission_time(data->bit_rate);
...
long int
schedule_packet_arrival_event2_no_reschedule(Simulation_Run_Ptr simulation_run,
	double event_time)
{
	Event event;

	event.description = "Packet Arrival";
	event.function = packet_arrival_event2_no_reschedule;
	event.attachment = (void*)NULL;
...
long int
schedule_packet_arrival_event3_no_reschedule(Simulation_Run_Ptr simulation_run,
	double event_time)
{
	Event event;

	event.description = "Packet Arrival";
	event.function = packet_arrival_event3_no_reschedule;
	event.attachment = (void*)NULL;
...
void
packet_arrival_event3_no_reschedule(Simulation_Run_Ptr simulation_run, void* ptr)
{
	Simulation_Run_Data_Ptr data;
	Packet_Ptr new_packet;
