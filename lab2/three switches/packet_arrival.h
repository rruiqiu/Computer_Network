...
void
packet_arrival_event2_no_reschedule(Simulation_Run_Ptr, void*);

long
schedule_packet_arrival_event2_no_reschedule(Simulation_Run_Ptr, double);

void
packet_arrival_event3_no_reschedule(Simulation_Run_Ptr, void*);

long
schedule_packet_arrival_event3_no_reschedule(Simulation_Run_Ptr, double);
