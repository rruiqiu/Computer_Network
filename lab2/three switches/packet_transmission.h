...
double
get_packet_transmission_time(long int);

long schedule_end_packet_transmission_event(Simulation_Run_Ptr, double, Server_Ptr);

long schedule_end_packet_transmission_event2(Simulation_Run_Ptr, double, Server_Ptr);

long schedule_end_packet_transmission_event3(Simulation_Run_Ptr, double, Server_Ptr);
